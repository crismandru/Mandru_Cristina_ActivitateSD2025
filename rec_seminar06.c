...
//#include <string.h>
//
//// chaining, liniar probing, quadratic probing, double hashing, rehashing
//// rehashing - cand avem toate pozitiile ocupate si mai avem de adaugat,
//// facem o noua dimensiune si rehashuim
//
